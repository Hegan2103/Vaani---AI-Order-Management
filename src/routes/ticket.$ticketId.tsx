...
import { bookNameFor, listedVendors, mergeOneTicket, useVaani, vendorById, vendorForPhone } from "@/lib/vaani/store";
      ...
      <div className="mt-1 flex flex-wrap items-end justify-between gap-3">
        <div>
          <h1 className="font-display text-3xl tracking-tight md:text-4xl">
            {role === "vendor" ? bookNameFor(ticket.customerPhone, ticket.customerName || t("customer")) : customerVendorTitle}
          </h1>
