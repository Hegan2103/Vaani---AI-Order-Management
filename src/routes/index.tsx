...
import { INDUSTRY_LABEL, VENDORS, formatInPhone, samplesFor } from "@/lib/vaani/seed";
...
function Home() {
  ...
  const industryHint = useVaani((s) => s.industry);
  ...
  return (
    <>
      ...
      <p className="mt-4 text-xs text-subtle">
        Say product + quantity to order. Say product + cost/rate/kitna to inquire.
        Hindi, English, and other Indian languages work. Spoken names stay as spoken.
      </p>

      <div className="mt-3 flex flex-wrap gap-2">
        {samplesFor(industry !== "all" ? industry : industryHint).map((s) => (
