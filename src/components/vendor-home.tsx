      ...
      <div className="mb-6 grid gap-6 md:grid-cols-[1.2fr_0.8fr]">
        <div>
          ...
          <p className="mt-2 max-w-prose text-sm text-muted">
            You are identified by this shop name, mobile, and trade — not another login. Other buyers who
            have your number send lists here.
          </p>
        </div>
        <ShopCard />
      </div>
      ...
      {!shopName || !shopIndustry || !listed ? (
        <div className="rounded-[var(--radius-xl)] border border-dashed border-line-strong bg-surface px-6 py-12 text-center">
          ...
          <p className="mt-1 text-sm text-muted">
            Save shop name, pick your industry, and tick “I sell on Vaani”. That is how buyers know which
            trade you serve.
          </p>
        </div>
      ) : inbox.length === 0 ? (
